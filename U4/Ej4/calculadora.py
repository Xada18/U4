...
class Calculadora:
    def __init__(self):
        ...
        color = ttk.Label(mainframe,text="a+bi", background='light yellow', font="Arial 12").grid(column=4,row=0, columnspan=2, rowspan=6, **opts)
        ...
        ttk.Button(mainframe, text='C', command=self.borrarPanel).grid(column=4, row=5, sticky=W)
